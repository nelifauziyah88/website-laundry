    ...
    >
      ...
      >
        ...
        >
          ...
          <p style={{ fontSize: 15, color: colors.inkSoft, marginBottom: 32 }}>
          ...
          <form style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <label style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 14, color: colors.ink, cursor: "pointer" }}>
                <input
                  type="checkbox"
                  checked={rememberMe}
              ...
              <a href="#" style={{ fontSize: 14, color: colors.orange, fontWeight: 500 }}>
                Lupa password?
              </a>
            </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16, margin: "28px 0" }}>
            ...
            <span style={{ fontSize: 13.5, color: colors.inkSoft, whiteSpace: "nowrap" }}>Atau lanjutkan dengan</span>
            <div style={{ flex: 1, height: 1, backgroundColor: colors.line }} />
          </div>
          ...
          >
            <svg width="20" height="20" viewBox="0 0 48 48">
              <path fill="#FFC107" d="M43.6 20.5H42V20H24v8h11.3C33.9 32.6 29.4 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3.1 0 5.9 1.2 8 3.1l5.7-5.7C34.5 6 29.5 4 24 4 12.9 4 4 12.9 4 24s8.9 20 20 20 20-8.9 20-20c0-1.2-.1-2.4-.4-3.5z" />
              ...
              <path fill="#4CAF50" d="M24 44c5.4 0 10.3-1.9 14-5.3l-6.5-5.4C29.4 35.4 26.9 36 24 36c-5.3 0-9.8-3.4-11.4-8.1l-6.5 5C9.5 39.6 16.2 44 24 44z" />
              <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.7 2.1-2 3.9-3.8 5.3l6.5 5.4C39.9 37.4 44 31.4 44 24c0-1.2-.1-2.4-.4-3.5z" />
            </svg>
            Masuk dengan Google
          </button>
        </div>
        ...
        >
          <Image
            ...
            width={340}
            height={340}
            style={{ width: "60%", maxWidth: 300, height: "auto", marginBottom: 32 }}
          />
          <p
            style={{
              fontSize: 17,
